...
class FSM:
    ...
    def process(self, input_symbol):
        ...
        (self.action, self.next_state) = self.get_transition(self.input_symbol,
                                                             self.current_state)
...
#                              BeginBuildNumber,'BUILDING_NUMBER')
#     f.add_transition_list (string.digits,     'BUILDING_NUMBER',
#                              BuildNumber,      'BUILDING_NUMBER')
