...
int main(int argc, char **argv)
{
    ...
    // load schema to get a nicer prints (keypath tag names etc.)
    ...
    if (CONFD_OK != register_error_callback(dctx)) {
        confd_fatal("Failed to register error formatting callback!\n");
    }
