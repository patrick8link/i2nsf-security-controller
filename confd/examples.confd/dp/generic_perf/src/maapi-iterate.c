/*********************************************************************
 * A generic maapi_iterate() implementation for reading data in ConfD
 * keypath+value format that can be used to to for example transform
 * the data into a format not supported by maapi_save_config().
 *
