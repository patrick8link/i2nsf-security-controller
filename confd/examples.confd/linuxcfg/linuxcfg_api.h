...
// for use in data providers that want to check if the config exists in CDB;
// returns 1 if the config exists in CDB;
extern int config_cdb_exists(confd_hkeypath_t *kp);
