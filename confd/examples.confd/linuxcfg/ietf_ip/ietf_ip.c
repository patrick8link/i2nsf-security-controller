...
static struct confd_data_cbs transpoints[] = {
    { .callpoint = "ip_state_ipv4", .get_attrs = ipv4_get_attrs,
      .get_elem = ipv4_get_elem, .exists_optional = ipv4_get_elem,
      .get_next = ipv4_get_next, .get_case = ipv4_get_case },
    { .callpoint = "ip_state_ipv6", .get_attrs = ipv6_get_attrs,
      .get_elem = ipv6_get_elem, .exists_optional = ipv6_get_elem,
