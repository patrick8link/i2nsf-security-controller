...
class query_nsf_capability(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module ietf-i2nsf-registration-interface - based on the path /ietf_i2nsf_registration_interface_rpc/nsf-capability-registration/input/query-nsf-capability. Each member element of
...
capabilities in this field restrict the output field.
  """
  __slots__ = ('_path_helper', '_extmethods', '__directional_capabilities','__event_capabilities','__condition_capabilities','__action_capabilities','__resolution_strategy_capabilities','__default_action_capabilities',)

  _yang_name = 'query-nsf-capability'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['ietf_i2nsf_registration_interface_rpc', 'nsf-capability-registration', 'input', 'query-nsf-capability']

  def _get_directional_capabilities(self):
    """
    Getter method for directional_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/directional_capabilities (identityref)
...
flow (i.e., unidirectional or bidirectional traffic flow).
  ...
  def _set_directional_capabilities(self, v, load=False):
    """
    Setter method for directional_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/directional_capabilities (identityref)
...
flow (i.e., unidirectional or bidirectional traffic flow).
  ...
  def _get_event_capabilities(self):
    """
    Getter method for event_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/event_capabilities (container)
...
according to system event and system alarm.
  ...
  def _set_event_capabilities(self, v, load=False):
    """
    Setter method for event_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/event_capabilities (container)
    If this variable is read-only (config: false) in the
...
according to system event and system alarm.
  ...
  def _get_condition_capabilities(self):
    """
    Getter method for condition_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/condition_capabilities (container)
  ...
  def _set_condition_capabilities(self, v, load=False):
    """
    Setter method for condition_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/condition_capabilities (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_action_capabilities(self):
    """
    Getter method for action_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities (container)
...
actions for policy rules.
  ...
  def _set_action_capabilities(self, v, load=False):
    """
    Setter method for action_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities (container)
    If this variable is read-only (config: false) in the
...
actions for policy rules.
  ...
  def _get_resolution_strategy_capabilities(self):
    """
    Getter method for resolution_strategy_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/resolution_strategy_capabilities (identityref)
...
with another similar policy rule.
  ...
  def _set_resolution_strategy_capabilities(self, v, load=False):
    """
    Setter method for resolution_strategy_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/resolution_strategy_capabilities (identityref)
    If this variable is read-only (config: false) in the
...
with another similar policy rule.
  ...
  def _get_default_action_capabilities(self):
    """
    Getter method for default_action_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/default_action_capabilities (identityref)
...
defined as pass, drop, reject, rate-limit, or mirror.
  ...
  def _set_default_action_capabilities(self, v, load=False):
    """
    Setter method for default_action_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/default_action_capabilities (identityref)
    If this variable is read-only (config: false) in the
