...
class action_capabilities(PybindBase):
  ...
  from YANG module ietf-i2nsf-registration-interface - based on the path /ietf_i2nsf_registration_interface_rpc/nsf-capability-registration/input/query-nsf-capability/action-capabilities. Each member element of
...
actions for policy rules.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['ietf_i2nsf_registration_interface_rpc', 'nsf-capability-registration', 'input', 'query-nsf-capability', 'action-capabilities']

  def _get_ingress_action_capability(self):
    """
    Getter method for ingress_action_capability, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities/ingress_action_capability (identityref)
  ...
  def _set_ingress_action_capability(self, v, load=False):
    """
    Setter method for ingress_action_capability, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities/ingress_action_capability (identityref)
  ...
  def _get_egress_action_capability(self):
    """
    Getter method for egress_action_capability, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities/egress_action_capability (identityref)
  ...
  def _set_egress_action_capability(self, v, load=False):
    """
    Setter method for egress_action_capability, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities/egress_action_capability (identityref)
    If this variable is read-only (config: false) in the
  ...
  def _get_log_action_capability(self):
    """
    Getter method for log_action_capability, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities/log_action_capability (identityref)
  ...
  def _set_log_action_capability(self, v, load=False):
    """
    Setter method for log_action_capability, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/input/query_nsf_capability/action_capabilities/log_action_capability (identityref)
    If this variable is read-only (config: false) in the
