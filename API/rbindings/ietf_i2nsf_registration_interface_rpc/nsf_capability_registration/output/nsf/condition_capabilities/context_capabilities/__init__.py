...
class context_capabilities(PybindBase):
  ...
  from YANG module ietf-i2nsf-registration-interface - based on the path /ietf_i2nsf_registration_interface_rpc/nsf-capability-registration/output/nsf/condition-capabilities/context-capabilities. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['ietf_i2nsf_registration_interface_rpc', 'nsf-capability-registration', 'output', 'nsf', 'condition-capabilities', 'context-capabilities']

  def _get_time_capabilities(self):
    """
    Getter method for time_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/time_capabilities (identityref)
...
specific time.
  ...
  def _set_time_capabilities(self, v, load=False):
    """
    Setter method for time_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/time_capabilities (identityref)
...
specific time.
  ...
  def _get_application_filter_capabilities(self):
    """
    Getter method for application_filter_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/application_filter_capabilities (identityref)
  ...
  def _set_application_filter_capabilities(self, v, load=False):
    """
    Setter method for application_filter_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/application_filter_capabilities (identityref)
    If this variable is read-only (config: false) in the
  ...
  def _get_device_type_capabilities(self):
    """
    Getter method for device_type_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/device_type_capabilities (identityref)
...
(i.e., router, switch, pc, ios, or android).
  ...
  def _set_device_type_capabilities(self, v, load=False):
    """
    Setter method for device_type_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/device_type_capabilities (identityref)
    If this variable is read-only (config: false) in the
...
(i.e., router, switch, pc, ios, or android).
  ...
  def _get_user_condition_capabilities(self):
    """
    Getter method for user_condition_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/user_condition_capabilities (identityref)
...
functions over the given user (or user group)
  ...
  def _set_user_condition_capabilities(self, v, load=False):
    """
    Setter method for user_condition_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/user_condition_capabilities (identityref)
    If this variable is read-only (config: false) in the
...
functions over the given user (or user group)
  ...
  def _get_geographic_capabilities(self):
    """
    Getter method for geographic_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/geographic_capabilities (identityref)
...
location of the source or destination
  ...
  def _set_geographic_capabilities(self, v, load=False):
    """
    Setter method for geographic_capabilities, mapped from YANG variable /ietf_i2nsf_registration_interface_rpc/nsf_capability_registration/output/nsf/condition_capabilities/context_capabilities/geographic_capabilities (identityref)
    If this variable is read-only (config: false) in the
